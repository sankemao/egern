...
// protobuf-ts 2.10.0
((s) => {
  (s.symbol = Symbol.for("protobuf-ts/unknown")),
    (s.onRead = (e, r, t, a, n) => {
      (i(r) ? r[s.symbol] : (r[s.symbol] = [])).push({
        no: t,
        wireType: a,
        data: n,
      });
    ...
    (s.list = (e, r) =>
      i(e) ? ((e = e[s.symbol]), r ? e.filter((e) => e.no == r) : e) : []),
    (s.last = (e, r) => s.list(e, r).slice(-1)[0]);
  ...
  is(e, a, n = !1) {
    if (!(a < 0)) {
      ...
      if (!(a < 1)) {
        ...
        for (var s of this.fields)
          if (void 0 === s.oneof && !this.field(e[s.localName], s, n, a))
            return !1;
      }
    }
    return !0;
...
function base64decode(r) {
  let e = (3 * r.length) / 4,
    ...
    s = 0;
  for (let e = 0; e < r.length; e++) {
    if (void 0 === (i = decTable[r.charCodeAt(e)]))
      switch (r[e]) {
        case "=":
          n = 0;
        case "\n":
...
function int64toString(e, r) {
  ...
  return (
    ...
    1e7 <= n && ((i += Math.floor(n / 1e7)), (n %= 1e7)),
    s(i, 0) + s(n, i) + s(a, 1)
  );
}
        ...
        if (BI)
          ...
          switch (typeof e) {
            case "string":
              ...
              var [r, t, a] = int64fromString(e);
              if (r) {
                if (a > HALF_2_PWR_32 || (a == HALF_2_PWR_32 && 0 != t))
                  throw new Error("signed long too small");
              } else if (a >= HALF_2_PWR_32)
...
let FLOAT32_MAX = 34028234663852886e22,
...
class ReflectionJsonReader {
  ...
  prepare() {
    ...
    if (void 0 === this.fMap) {
      this.fMap = {};
      for (r of null != (e = this.info.fields) ? e : [])
        (this.fMap[r.name] = r),
  ...
  read(e, r, t) {
    ...
    for ([a, n] of Object.entries(e)) {
      ...
      if (s.oneof) {
        if (
          null === n &&
          ("enum" !== s.kind || "google.protobuf.NullValue" !== s.T()[0])
        )
          continue;
      ...
      if ("map" == s.kind) {
          ...
          for ([c, u] of Object.entries(n)) {
            ...
            switch (s.V.kind) {
              ...
              case "enum":
                if (
                  !1 ===
                  (e = this.enum(s.V.T(), u, s.name, t.ignoreUnknownFields))
                )
                  continue;
                break;
              case "scalar":
            ...
            let r = c;
            s.K == ScalarType.BOOL && (r = "true" == r || ("false" != r && r)),
              (f[
                (r = this.scalar(r, s.K, LongType.STRING, s.name).toString())
              ] = e);
          }
        }
      } else if (s.repeat) {
          ...
          for (h of n) {
            ...
            switch (s.kind) {
              ...
              case "enum":
                if (
                  !1 ===
                  (e = this.enum(s.T(), h, s.name, t.ignoreUnknownFields))
                )
                  continue;
                break;
              case "scalar":
        ...
        switch (s.kind) {
          case "message":
            null === n && "google.protobuf.Value" != s.T().typeName
              ? this.assert(
                  void 0 === s.oneof,
                  s.name + " (oneof member)",
                  null
                )
              : (e[l] = s.T().internalJsonRead(n, t, e[l]));
            break;
          case "enum":
            null !== n &&
              !1 !== (o = this.enum(s.T(), n, s.name, t.ignoreUnknownFields)) &&
              (e[l] = o);
            break;
          case "scalar":
      ...
      switch (t) {
        ...
        case ScalarType.FLOAT:
          ...
          if ("" === r) n = "empty string";
            ...
            var i = Number(r);
            if (Number.isNaN(i)) n = "not a number";
            else {
              if (Number.isFinite(i))
                return t == ScalarType.FLOAT && assertFloat32(i), i;
...
class ReflectionJsonWriter {
  ...
  write(e, r) {
    var t,
      ...
      i = {},
      s = e;
    for (t of this.fields)
      t.oneof
        ? (a = s[t.oneof]).oneofKind === t.localName &&
          ((n =
            "scalar" == t.kind || "enum" == t.kind
              ? { ...r, emitDefaultValues: !0 }
              : r),
          assert(void 0 !== (a = this.field(t, a[t.localName], n))),
          (i[r.useProtoFieldName ? t.name : t.jsonName] = a))
        : void 0 !== (n = this.field(t, s[t.localName], r)) &&
          (i[r.useProtoFieldName ? t.name : t.jsonName] = n);
    return i;
  }
  field(r, t, a) {
    let e = void 0;
  ...
  enum(e, r, t, a, n, i) {
    ...
    if (void 0 === r) assert(a);
      ...
      return (
        ...
        i || !e[1].hasOwnProperty(r) ? r : e[2] ? e[2] + e[1][r] : e[1][r]
      );
  }
  message(e, r, t, a) {
    return void 0 === r
      ...
      if (o) {
        ...
        switch (
          ...
          case "message":
            r
              ? ((h = e[t]),
                (p = o.T().internalBinaryRead(a, a.uint32(), i)),
                h.push(p))
              : (e[t] = o.T().internalBinaryRead(a, a.uint32(), i, e[t]));
            break;
          case "map":
        ...
        if ("throw" == g)
          throw new Error(
            `Unknown field ${t} (wire type ${s}) for ` + this.info.typeName
          );
        var d = a.skip(s);
        !1 !== g &&
          (!0 === g ? UnknownFieldHandler.onRead : g)(
            this.info.typeName,
            n,
            t,
            s,
  ...
  mapEntry(e, r, t) {
    ...
    if (
      (void 0 === i &&
        ...
        (i = e.K == ScalarType.BOOL ? a.toString() : a)),
      void 0 === s)
    )
      switch (e.V.kind) {
        case "scalar":
...
class ReflectionBinaryWriter {
  ...
  write(n, i, s) {
        ...
        case "enum":
          ...
          if (t)
            if ((assert(Array.isArray(e)), t == RepeatType.PACKED))
              this.packed(i, c, o.no, e);
            else for (var u of e) this.scalar(i, c, o.no, u, !0);
          else
            void 0 === e
              ? assert(o.opt)
              : this.scalar(i, c, o.no, e, r || o.opt);
          break;
        case "message":
          if (t) {
    ...
    !1 !== e &&
      (!0 === e ? UnknownFieldHandler.onWrite : e)(this.info.typeName, n, i);
  }
  mapEntry(e, r, t, a, n) {
...
function reflectionCreate(e) {
  var r,
    t = e.messagePrototype
      ? Object.create(e.messagePrototype)
      : Object.defineProperty({}, MESSAGE_TYPE, { value: e });
  for (r of e.fields) {
    var a = r.localName;
    if (!r.opt)
...
function reflectionMergePartial(e, r, t) {
  ...
  for (var s of e.fields) {
    ...
    switch ((s.repeat && (i[o].length = a.length), s.kind)) {
      case "scalar":
      case "enum":
        if (s.repeat) for (let e = 0; e < a.length; e++) i[o][e] = a[e];
        else i[o] = a;
        break;
      case "message":
        var c = s.T();
        if (s.repeat)
          for (let e = 0; e < a.length; e++) i[o][e] = c.create(a[e]);
        else void 0 === i[o] ? (i[o] = c.create(a)) : c.mergePartial(i[o], a);
        break;
      case "map":
        switch (s.V.kind) {
          case "scalar":
...
function reflectionEquals(e, r, t) {
  if (r !== t) {
    ...
    for (var a of e.fields) {
      var n = a.localName,
        i = (a.oneof ? r[a.oneof] : r)[n],
        s = (a.oneof ? t[a.oneof] : t)[n];
      switch (a.kind) {
        case "enum":
        case "scalar":
        ...
        case "map":
          if (
            "message" == a.V.kind
              ? repeatedMsgEq(a.V.T(), objectValues(i), objectValues(s))
              : repeatedPrimitiveEq(
...
class BinaryReader {
  constructor(e, r) {
    (this.varint64 = varint64read),
      ...
      (this.textDecoder =
        null != r ? r : new TextDecoder("utf-8", { fatal: !0, ignoreBOM: !0 }));
  }
  tag() {
    var e = this.uint32(),
      r = e >>> 3,
...
let baseDescriptors = Object.getOwnPropertyDescriptors(
...
class FrsPageResIdl$Type extends MessageType {
  constructor() {
    super("FrsPageResIdl", [
      { no: 2, name: "data", kind: "message", T: () => FrsPageDataRes },
    ]);
  }
  create(e) {
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (2 === s)
        t.data = FrsPageDataRes.internalBinaryRead(e, e.uint32(), r, t.data);
      else {
  ...
  internalBinaryWrite(e, n, r) {
    e.data &&
      FrsPageDataRes.internalBinaryWrite(
        e.data,
...
class FrsPageDataRes$Type extends MessageType {
    ...
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      ...
      switch (s) {
        ...
        case 7:
          ...
          break;
        case 23:
          t.activityhead = ActivityHead.internalBinaryRead(
            e,
            e.uint32(),
            r,
            t.activityhead
          ...
          break;
        case 116:
          t.liveFuseForum.push(
            LiveFuseForumData.internalBinaryRead(e, e.uint32(), r)
          );
          break;
        case 126:
          t.pageData = PageData.internalBinaryRead(
            e,
            e.uint32(),
            r,
            t.pageData
  ...
  internalBinaryWrite(n, r, a) {
    n.forum &&
      ForumInfo.internalBinaryWrite(
        n.forum,
        r.tag(2, WireType.LengthDelimited).fork(),
        a
      ).join();
    for (let e = 0; e < n.threadList.length; e++)
      ThreadInfo.internalBinaryWrite(
        n.threadList[e],
        r.tag(7, WireType.LengthDelimited).fork(),
        a
      ).join();
    n.activityhead &&
      ActivityHead.internalBinaryWrite(
        n.activityhead,
        r.tag(23, WireType.LengthDelimited).fork(),
        a
      ).join();
    for (let e = 0; e < n.liveFuseForum.length; e++)
      LiveFuseForumData.internalBinaryWrite(
        n.liveFuseForum[e],
        r.tag(116, WireType.LengthDelimited).fork(),
        a
      ).join();
    n.pageData &&
      PageData.internalBinaryWrite(
        n.pageData,
        r.tag(126, WireType.LengthDelimited).fork(),
        a
      ).join();
...
class PageData$Type extends MessageType {
  ...
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.feedList = []), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (2 === s)
        t.feedList.push(LayoutFactory.internalBinaryRead(e, e.uint32(), r));
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
  ...
  internalBinaryWrite(n, r, a) {
    for (let e = 0; e < n.feedList.length; e++)
      LayoutFactory.internalBinaryWrite(
        n.feedList[e],
        r.tag(2, WireType.LengthDelimited).fork(),
        a
      ).join();
...
class ForumInfo$Type extends MessageType {
  constructor() {
    super("ForumInfo", [
      { no: 33, name: "banner_list", kind: "message", T: () => BannerList },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (33 === s)
        t.bannerList = BannerList.internalBinaryRead(
          e,
          e.uint32(),
          r,
          t.bannerList
  ...
  internalBinaryWrite(e, n, r) {
    e.bannerList &&
      BannerList.internalBinaryWrite(
        e.bannerList,
        n.tag(33, WireType.LengthDelimited).fork(),
        r
      ).join();
    r = r.writeUnknownFields;
    return (
...
class LiveFuseForumData$Type extends MessageType {
  constructor() {
    super("LiveFuseForumData", [
      { no: 1, name: "online_users", kind: "scalar", T: 9 },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryWrite(e, n, r) {
    "" !== e.onlineUsers &&
      n.tag(1, WireType.LengthDelimited).string(e.onlineUsers);
    r = r.writeUnknownFields;
    return (
      !1 !== r &&
        (1 == r ? UnknownFieldHandler.onWrite : r)(this.typeName, e, n),
...
class PbPageResIdl$Type extends MessageType {
  constructor() {
    super("PbPageResIdl", [
      { no: 2, name: "data", kind: "message", T: () => PbPageDataRes },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (2 === s)
        t.data = PbPageDataRes.internalBinaryRead(e, e.uint32(), r, t.data);
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
  ...
  internalBinaryWrite(e, n, r) {
    e.data &&
      PbPageDataRes.internalBinaryWrite(
        e.data,
        n.tag(2, WireType.LengthDelimited).fork(),
        r
      ).join();
...
class PbPageDataRes$Type extends MessageType {
  constructor() {
    super("PbPageDataRes", [
      { no: 12, name: "banner_list", kind: "message", T: () => BannerList },
      { no: 55, name: "recom_ala_info", kind: "message", T: () => AlaLiveInfo },
  ...
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.postList = []), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      ...
      switch (s) {
        case 12:
          ...
          break;
        case 55:
          t.recomAlaInfo = AlaLiveInfo.internalBinaryRead(
            e,
            e.uint32(),
            r,
            t.recomAlaInfo
  ...
  internalBinaryWrite(n, r, a) {
    for (let e = 0; e < n.postList.length; e++)
      Post.internalBinaryWrite(
        n.postList[e],
        r.tag(6, WireType.LengthDelimited).fork(),
        a
      ).join();
    n.bannerList &&
      BannerList.internalBinaryWrite(
        n.bannerList,
        r.tag(12, WireType.LengthDelimited).fork(),
        a
      ).join(),
      n.recomAlaInfo &&
        AlaLiveInfo.internalBinaryWrite(
          n.recomAlaInfo,
          r.tag(55, WireType.LengthDelimited).fork(),
          a
        ).join();
    var e = a.writeUnknownFields;
    return (
...
class PersonalizedResIdl$Type extends MessageType {
  constructor() {
    super("PersonalizedResIdl", [
      { no: 2, name: "data", kind: "message", T: () => PersonalizedDataRes },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (2 === s)
        t.data = PersonalizedDataRes.internalBinaryRead(
          e,
          e.uint32(),
          r,
          t.data
  ...
  internalBinaryWrite(e, n, r) {
    e.data &&
      PersonalizedDataRes.internalBinaryWrite(
        e.data,
        n.tag(2, WireType.LengthDelimited).fork(),
        r
      ).join();
...
class PersonalizedDataRes$Type extends MessageType {
  constructor() {
    super("PersonalizedDataRes", [
      { no: 9, name: "banner_list", kind: "message", T: () => BannerList },
      {
        no: 2,
        name: "thread_list",
        kind: "message",
  ...
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.threadList = []), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      ...
      switch (s) {
        ...
        case 2:
          ...
          break;
        case 17:
          t.liveAnswer = LiveAnswer.internalBinaryRead(
            e,
            e.uint32(),
            r,
            t.liveAnswer
  ...
  internalBinaryWrite(n, r, a) {
    ...
    n.bannerList &&
      ...
      n.liveAnswer &&
        LiveAnswer.internalBinaryWrite(
          n.liveAnswer,
          r.tag(17, WireType.LengthDelimited).fork(),
          a
        ).join();
    var e = a.writeUnknownFields;
    return (
...
class LiveAnswer$Type extends MessageType {
  ...
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.bannerUrl = ""), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (1 === s) t.bannerUrl = e.string();
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
  ...
  internalBinaryWrite(e, n, r) {
    "" !== e.bannerUrl &&
      n.tag(1, WireType.LengthDelimited).string(e.bannerUrl);
    r = r.writeUnknownFields;
    return (
      !1 !== r &&
        (1 == r ? UnknownFieldHandler.onWrite : r)(this.typeName, e, n),
...
class ThreadListResIdl$Type extends MessageType {
  constructor() {
    super("ThreadListResIdl", [
      { no: 2, name: "data", kind: "message", T: () => ThreadListDataRes },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (2 === s)
        t.data = ThreadListDataRes.internalBinaryRead(e, e.uint32(), r, t.data);
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
  ...
  internalBinaryWrite(e, n, r) {
    e.data &&
      ThreadListDataRes.internalBinaryWrite(
        e.data,
        n.tag(2, WireType.LengthDelimited).fork(),
        r
      ).join();
...
class ThreadListDataRes$Type extends MessageType {
  constructor() {
    super("ThreadListDataRes", [
      { no: 3, name: "banner_list", kind: "message", T: () => BannerList },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
...
class GeneralTabListResIdl$Type extends MessageType {
  constructor() {
    super("GeneralTabListResIdl", [
      { no: 2, name: "data", kind: "message", T: () => GeneralTabListDataRes },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (2 === s)
        t.data = GeneralTabListDataRes.internalBinaryRead(
          e,
          e.uint32(),
          r,
          t.data
  ...
  internalBinaryWrite(e, n, r) {
    e.data &&
      GeneralTabListDataRes.internalBinaryWrite(
        e.data,
        n.tag(2, WireType.LengthDelimited).fork(),
        r
      ).join();
...
class GeneralTabListDataRes$Type extends MessageType {
  constructor() {
    super("GeneralTabListDataRes", [
      { no: 10, name: "app_list", kind: "message", repeat: 2, T: () => App },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.appList = []), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (10 === s) t.appList.push(App.internalBinaryRead(e, e.uint32(), r));
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
  ...
  internalBinaryWrite(n, r, a) {
    for (let e = 0; e < n.appList.length; e++)
      App.internalBinaryWrite(
        n.appList[e],
        r.tag(10, WireType.LengthDelimited).fork(),
        a
      ).join();
    var e = a.writeUnknownFields;
    return (
...
class BannerList$Type extends MessageType {
  constructor() {
    super("BannerList", [
      { no: 1, name: "app", kind: "message", repeat: 2, T: () => App },
      { no: 5, name: "pb_banner_ad", kind: "message", T: () => App },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryWrite(n, r, a) {
    ...
    n.pbBannerAd &&
      App.internalBinaryWrite(
        n.pbBannerAd,
        r.tag(5, WireType.LengthDelimited).fork(),
        a
      ).join();
    var e = a.writeUnknownFields;
    return (
...
class App$Type extends MessageType {
  constructor() {
    super("App", [
      ...
      { no: 38, name: "live_ad", kind: "message", T: () => LiveAdData },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.goodsInfo = []), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
  ...
  internalBinaryWrite(n, r, a) {
    for (let e = 0; e < n.goodsInfo.length; e++)
      GoodsInfo.internalBinaryWrite(
        n.goodsInfo[e],
        r.tag(30, WireType.LengthDelimited).fork(),
        a
      ).join();
    n.liveAd &&
      LiveAdData.internalBinaryWrite(
        n.liveAd,
        r.tag(38, WireType.LengthDelimited).fork(),
        a
      ).join();
    var e = a.writeUnknownFields;
    return (
...
class LiveAdData$Type extends MessageType {
  constructor() {
    super("LiveAdData", [
      { no: 1, name: "recom_ala_info", kind: "message", T: () => AlaLiveInfo },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
...
class ThreadInfo$Type extends MessageType {
  constructor() {
    super("ThreadInfo", [
      { no: 79, name: "video_info", kind: "message", T: () => VideoInfo },
      { no: 113, name: "ala_info", kind: "message", T: () => AlaLiveInfo },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      ...
      switch (s) {
        case 79:
          t.videoInfo = VideoInfo.internalBinaryRead(
            e,
            e.uint32(),
            r,
            t.videoInfo
          ...
          break;
        case 113:
          t.alaInfo = AlaLiveInfo.internalBinaryRead(
            e,
            e.uint32(),
            r,
            t.alaInfo
  ...
  internalBinaryWrite(e, n, r) {
    e.videoInfo &&
      VideoInfo.internalBinaryWrite(
        e.videoInfo,
        n.tag(79, WireType.LengthDelimited).fork(),
        r
      ).join(),
      e.alaInfo &&
        AlaLiveInfo.internalBinaryWrite(
          e.alaInfo,
          n.tag(113, WireType.LengthDelimited).fork(),
          r
        ).join();
    r = r.writeUnknownFields;
    return (
...
class AlaLiveInfo$Type extends MessageType {
  constructor() {
    super("AlaLiveInfo", [
      { no: 1, name: "live_id", kind: "scalar", T: 4, L: 0 },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.liveId = 0n), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (1 === s) t.liveId = e.uint64().toBigInt();
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
...
class Post$Type extends MessageType {
  constructor() {
    super("Post", [
      { no: 54, name: "outer_item", kind: "message", T: () => Item },
      {
        no: 67,
    ...
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      ...
      switch (s) {
        case 54:
          ...
          break;
        case 67:
          t.novelRecomCard = NovelRecomCard.internalBinaryRead(
            e,
            e.uint32(),
            r,
            t.novelRecomCard
  ...
  internalBinaryWrite(e, n, r) {
    e.outerItem &&
      Item.internalBinaryWrite(
        e.outerItem,
        n.tag(54, WireType.LengthDelimited).fork(),
        r
      ).join(),
      e.novelRecomCard &&
        NovelRecomCard.internalBinaryWrite(
          e.novelRecomCard,
          n.tag(67, WireType.LengthDelimited).fork(),
          r
        ).join();
    r = r.writeUnknownFields;
    return (
...
class Item$Type extends MessageType {
  ...
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.itemId = 0n), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (1 === s) t.itemId = e.int64().toBigInt();
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
...
class NovelRecomCard$Type extends MessageType {
  constructor() {
    super("NovelRecomCard", [
      { no: 1, name: "icon_url", kind: "scalar", T: 9 },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.iconUrl = ""), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (1 === s) t.iconUrl = e.string();
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
...
class VideoInfo$Type extends MessageType {
  ...
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
    return (
      (n.videoMd5 = ""), void 0 !== e && reflectionMergePartial(this, n, e), n
    );
  }
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (1 === s) t.videoMd5 = e.string();
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
...
class LayoutFactory$Type extends MessageType {
  constructor() {
    super("LayoutFactory", [
      { no: 2, name: "feed", kind: "message", T: () => FeedLayout },
    ]);
  }
  create(e) {
    var n = globalThis.Object.create(this.messagePrototype);
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (2 === s)
        t.feed = FeedLayout.internalBinaryRead(e, e.uint32(), r, t.feed);
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
  ...
  internalBinaryWrite(e, n, r) {
    e.feed &&
      FeedLayout.internalBinaryWrite(
        e.feed,
        n.tag(2, WireType.LengthDelimited).fork(),
        r
      ).join();
...
class FeedLayout$Type extends MessageType {
  ...
  internalBinaryRead(e, n, r, a) {
    for (var t = null != a ? a : this.create(), i = e.pos + n; e.pos < i; ) {
      var [s, o] = e.tag();
      if (5 === s)
        t.businessInfo.push(FeedKV.internalBinaryRead(e, e.uint32(), r));
      else {
        var l = r.readUnknownField;
        if ("throw" === l)
          throw new globalThis.Error(
  ...
  internalBinaryWrite(n, r, a) {
    for (let e = 0; e < n.businessInfo.length; e++)
      FeedKV.internalBinaryWrite(
        n.businessInfo[e],
        r.tag(5, WireType.LengthDelimited).fork(),
        a
      ).join();
...
class FeedKV$Type extends MessageType {
  ...
  internalBinaryWrite(e, n, r) {
    "" !== e.key && n.tag(1, WireType.LengthDelimited).string(e.key),
      "" !== e.value && n.tag(2, WireType.LengthDelimited).string(e.value);
    r = r.writeUnknownFields;
    return (
      !1 !== r &&
        (1 == r ? UnknownFieldHandler.onWrite : r)(this.typeName, e, n),
...
if (resStatus !== 200) {
  ...
  if (url.includes("frs/page")) {
    ...
    frsPageResIdlObj.data.threadList = removeThread(
    ...
    if (frsPageResIdlObj.data.pageData?.feedList?.length) {
      let liveCount = 0;
      frsPageResIdlObj.data.pageData.feedList =
        frsPageResIdlObj.data.pageData.feedList.filter((item) => {
          if (item.feed == null || item.feed.businessInfo == null) {
            return true;
          }
          const isLive = item.feed.businessInfo.some(
            (el) => el.key === "is_live_card" && el.value === "1"
          );
          if (isLive) {
            liveCount++;
          }
    ...
    console.log("pbPageResIdlObj", pbPageResIdlObj)

    removeGoodsInfo(pbPageResIdlObj.data.bannerList?.app);

    const bannerGoodsInfoLength =
      pbPageResIdlObj.data.bannerList?.pbBannerAd?.goodsInfo?.length;
    ...
    personalizedResIdlObj.data.threadList = removeThread(
    ...
    const generalTabListResIdlObj = GeneralTabListResIdl.fromBinary(
      binaryBody,
      { readUnknownField: true }
    );
